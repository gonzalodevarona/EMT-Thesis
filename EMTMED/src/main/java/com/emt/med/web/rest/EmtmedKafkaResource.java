...
import com.emt.med.config.KafkaSseConsumer;
import com.emt.med.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/emtmed-kafka")
public class EmtmedKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EmtmedKafkaResource.class);
    ...
    public EmtmedKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
