...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COUNTINGUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COUNTINGUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COUNTINGUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COUNTINGUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COUNTINGUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COUNTINGUNIT actions', async () => {
      const expectedActions = [
        {
