...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEIGHTUNIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEIGHTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEIGHTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEIGHTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEIGHTUNIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEIGHTUNIT actions', async () => {
      const expectedActions = [
        {
